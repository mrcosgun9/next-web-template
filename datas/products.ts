...
export const products: IProduct[] = [
  {
    ...
    images: [
      {
        min: "/images/products/bathroom-accessories/min/bathroom-accessories1.jpg",
        max: "/images/products/bathroom-accessories/bathroom-accessories1.jpg",
      },
      {
  ...
  },
  {
    ...
    images: [
      {
        min: "/images/products/plumbing-fixtures/min/plumbing-fixtures1.jpg",
